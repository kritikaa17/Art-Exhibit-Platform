        ...
        success: function(res){
            ...
            if(res.bool == true){
                ...
                let _html =  ' <div class="single-comment justify-content-between d-flex mb-30">'
                    ...
                    _html += '<img src="https://i.pinimg.com/originals/58/51/2e/58512eb4e598b5ea4e2414e3c115bef9.jpg" alt="" />'
...
$(document).ready(function(){
    ...
    $(document).on("click",".make-default-address",function(){
        ...
        $.ajax({
            ...
            dataType:"json",
            success: function(response){
                console.log("Address made defaukt");
    ...
    $(document).on("click", ".delete-wishlist-product", function(){
        let wishlist_id = $(this).attr("data-wishlists-product")
        let this_val = $(this)

        console.log("Wislist id is:", wishlist_id);
        $.ajax({
